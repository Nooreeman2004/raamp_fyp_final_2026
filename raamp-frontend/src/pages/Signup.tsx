...
import { staggerContainer, fadeInUp, hoverScale, scaleUp, fadeIn } from "@/utils/animations";
...
const Signup = () => {
    ...
    try {
      ...
      if (apiError.errors) {
        ...
        if (apiError.errors.email && typeof apiError.errors.email === 'string' &&
            apiError.errors.email.includes("verification")) {
          toast({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-card to-background p-4 overflow-hidden">
      {/* 1. Zoom In Entrance for the whole card */}
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`bg-background/50 pr-10 ${touched.username
                      ? usernameValidation.valid
                        ? "border-success"
                        : "border-destructive"
                      : ""
              ...
              <motion.div variants={fadeInUp} className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`bg-background/50 pr-10 ${touched.email
                      ? emailValidation.valid
                        ? "border-success"
                        : "border-destructive"
                      : ""
              ...
              <motion.div variants={fadeInUp} className="space-y-2">
                ...
                {/* Password Strength Meter - Animates in when password exists */}
                <AnimatePresence>
                  {password && (
                    <motion.div 
