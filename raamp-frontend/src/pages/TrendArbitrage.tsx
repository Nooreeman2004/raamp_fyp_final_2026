                ...
                {trends.map((trend, idx) => (
                  <motion.div key={idx} variants={fadeInUp}>
                    <motion.div 
                      ...
                      initial="rest" 
                      whileHover="hover"
                      className="p-4 bg-muted/50 rounded-lg border border-primary/10 hover:border-primary/30 transition-colors group"
                    >
                      ...
                      <motion.div variants={hoverScale} whileTap="tap" className="mt-3 inline-block">
